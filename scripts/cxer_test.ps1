#===============================================================================
# cxer_test.ps1 - Test xer.exe with test data
#
# Usage:
#   .\scripts\cxer_test.ps1
#===============================================================================
...
# Paths
$XerExe = Join-Path (Join-Path $ScriptDir "..") "cxer\origin.exe"
...
Write-Host "  xer - Test BER <-> APER Conversion"
Write-Host "========================================"
Write-Host ""
...
if (-not (Test-Path $XerExe)) {
    ...
    Write-Host ""
    Write-Host "Run cxer_build.ps1 first."
    exit 1
}
