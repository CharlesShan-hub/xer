#===============================================================================
# windows-pxer_env.ps1 - Python environment setup (uv-based)
...
Write-Host "--- xer - Python Environment Setup (uv) ---" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "--- xer - Python environment ready! ---" -ForegroundColor Green
Write-Host ""
