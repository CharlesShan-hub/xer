#===============================================================================
# windows-cxer_env.ps1 - Check C build environment (MSVC)
...
Write-Host "--- xer - C Build Environment Check ---" -ForegroundColor Cyan
Write-Host ""
...
#===============================================================================
Write-Host ""
Write-Host "--- xer - C build environment check done ---" -ForegroundColor Cyan
Write-Host ""
